...
var descriptionSource = docment.getElementById("despsrc");
...
//Function to display the plank exmaple video
function plank() {
    videoSource.src = "media/plank-descriptions.vtt";
